        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-white/70">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/krupanidhi_jewellers?igsh=MXc0ZDVqbjA4NWU0eg==" target="_blank" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-gold-400 hover:text-black hover:border-transparent transition-all duration-300">
